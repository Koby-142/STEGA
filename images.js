  ...
  ajaxModule.prototype = {
    ...
    parseResponse: function(response) {
      ...
      $.each(response.hits, function(index, value) {
        $(".wrapper").prepend("<div class='overlay-image image" + index + "' style='width:100%" + "px; height:" + "200px; background: url(" + value.webformatURL + ");'><a href='" + value.pageURL + "' target='_blank'><div class='overlay'></div></a><div class='hidden'></div></div>");
